const { Tier, RedemptionItem, Offer, MenuItem, Member } = require('./models');
const { PLATINUM, upgradeQualifyingMembers } = require('./services/tierService');
...
async function seedCatalog() {
  ...
  await upgradeQualifyingMembers();
  for (const item of [
